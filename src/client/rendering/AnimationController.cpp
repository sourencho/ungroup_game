...
void AnimationController::load() {
    ...
    /*
    mResourceStore.addTexture("test",
    "resources/images/spritesheet_test-01.png"); auto animated_sprite =
    std::unique_ptr<AnimatedSprite>( new
    AnimatedSprite(mResourceStore.getTexture("test"), {3, 3}, 9000, {100.f,
    300.f}));
